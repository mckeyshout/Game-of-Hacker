...
def game_end_cont():
    ...
    if list == [1,5]:
        ...
        b33_cc()
        ms.sound_winner()
        messagebox.showinfo(title="CONGRATULATIONS", message="Congrats. SCRIPT KIDDIE 1 is unlocked!")
