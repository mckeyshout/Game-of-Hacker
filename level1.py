...
def game_end_cont():
    ...
    if list == [1]:
        ...
        b33_cc()
        ms.sound_winner()
        messagebox.showinfo(title="CONGRATULATIONS", message="Congrats. LAMER 2 is unlocked!")
