...
def game_end_cont():
    ...
    if list == [1,5,9]:
        ...
        b32_cc()
        b33_cc()
        messagebox.showinfo(title="CONGRATULATIONS", message="Congrats. SCRIPT KIDDIE 2 is unlocked!")
