...
def game_end_cont():
    ...
    if list == [1, 2, 3, 5, 6, 7, 9, 10, 11, 13, 14]:
        ...
        b32_cc()
        b33_cc()
        messagebox.showinfo(title="CONGRATULATIONS", message="Congrats. GREY HAT 2 is unlocked!")
