...
def game_end_cont():
    ...
    if list == [1,5,9,13]:
        ...
        b33_cc()
        ms.sound_winner()
        messagebox.showinfo(title="CONGRATULATIONS", message="Congrats. PHREAKER 1 is unlocked!")
