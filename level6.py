...
def game_end_cont():
    ...
    if list == [1,2,5,6,9,13]:
        ...
        b32_cc()
        b33_cc()
        messagebox.showinfo(title="CONGRATULATIONS", message="Congrats. CRACKER 1 is unlocked!")
