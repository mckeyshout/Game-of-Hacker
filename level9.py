...
def game_end_cont():
    ...
    if list == [1,2,3,5,6,9,10,13,14]:
        ...
        b33_cc()
        ms.sound_winner()
        messagebox.showinfo(title="CONGRATULATIONS", message="Congrats. HACKTIVIST 2 is unlocked!")
